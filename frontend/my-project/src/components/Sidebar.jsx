  ...
  return (
    <div className="bg-[#bed4d9] rounded-b-md w-[250px] min-h-screen flex flex-col items-start justify-between p-4 gap-4">
      <div className="flex flex-col gap-2 items-start">
        ...
        <label>Target Date (Sets Month):</label>
        <span className="text-xs text-gray-500 -mt-2">
          Budget applies to full month of date picked
        </span>
        <input
          onChange={(e) => setTarget(e.target.value)}
          value={target}
          type="date"
          className="bg-white px-2 py-1 rounded-lg outline-0 focus:border-[#504450] focus:ring-2 focus:ring-[#504450]}"
        ></input>
        <button
